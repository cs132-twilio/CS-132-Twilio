...
<button type="submit" class="btn btn-danger" style="display : none;" id="delete-button" onClick="return Twexter.modules.Flashcards.confirmSubmit()">Delete Selected Cards</button><span id="card_deleted"></span>
