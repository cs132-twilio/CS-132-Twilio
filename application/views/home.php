...
<div class="hero-unit span8 offset1 welcome_container">
  <div class="row">
	...
	<h2>You\'re logged in to twexter. Head over to the dashboard to manage your classes.
	<a href="dashboard" class="btn btn-large btn-info big-button">Go to Dashboard</a></h2>
