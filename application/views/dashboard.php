...
<div class="span2">
  ...
  <ul id="classTabs" class="nav nav-pills nav-stacked">
      ...
      <li class="active"><a onclick="return Twexter.dashboard.setClass(1);">Math</a></li>
      <li onclick="this.className='active'"><a onclick="return Twexter.ajax_load('/list/2', 'moduleContent');">Biology</a></li>
      <li onclick="this.className='active'"><a onclick="return Twexter.ajax_load('/list/3', 'moduleContent');">Web Applications</a></li>
  </ul>
</div>
...
<div id="modules" class="span10">
  <!--Body content-->
    <ul id="moduleTabs" class="nav nav-tabs">
      <li class="active"><a onclick="return Twexter.ajax_load('/list/1', 'moduleContent');">List</a></li>
